...
def draw__figure( Data=None, settings=None, settingFile=None ):
    ...
    fig.add__plot( xAxis=Data[:,t_], yAxis=Data[:,NA_]/settings["figure.num.factor.y"], \
                   color="C0", label=settings["figure.num.label.A"] )
    fig.add__plot( xAxis=Data[:,t_], yAxis=Data[:,NB_]/settings["figure.num.factor.y"], \
    ...
    fig.add__plot( xAxis=Data[:,t_], yAxis=Data[:,AA_]/settings["figure.act.factor.y"],\
                   color="C0", label=settings["figure.act.label.A"] )
    fig.add__plot( xAxis=Data[:,t_], yAxis=Data[:,AB_]/settings["figure.act.factor.y"],\
